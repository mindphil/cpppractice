Learning through tinkering. Goal is to be able to interpret and contribute to 2swap's [n-cop](https://github.com/mindphil/ncopgame) [solver](https://github.com/mindphil/n-cop).


[Challenges](https://github.com/mindphil/cpppractice/tree/main/bitops)
